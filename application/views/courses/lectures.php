...
<html class="st-layout ls-top-navbar-large ls-bottom-footer show-sidebar sidebar-l3" lang="en">
    <head>
        ...
        <title><?php echo "Lessons | ".$this->config->item('sitename');?></title>
        <!-- Vendor CSS BUNDLE
                    ...
                    <div class="st-content-inner padding-none">
                        ...
                        <div class="container-fluid">
                            <div class="page-section">
                                <h1 class="text-display-1">Course Lessons</h1>
                            </div>
                            <?php $lessons = $this->courses->get_lessons($course['cid']);
                                    $no_lessons = count($lessons);
                                    $courseid = $course['cid'];
                            ?>
                                            ...
                                            <div class="nestable-content">
                                                <div class="media v-middle">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <a href='<?php echo base_url()."courses/".$courseid."/lessons/".$lesson['id'];?>' class="link-text-color"><?php echo $lesson['title'];?></a>
                                                        </h4>
                                                        <?php $role = "Private";
                                                            if($lesson['is_public']) $role ="Public";
                                                            $iso = date(DATE_RFC2822,strtotime($lesson['upload_time'])); $dis = date('l jS \of F Y h:i:s A',strtotime($lesson['upload_time'])); ?>
                                                        <div class="text-caption"><?php echo $role; ?>
                                                            <br>last updated  
