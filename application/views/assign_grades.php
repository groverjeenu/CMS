...
<head>
  ...
  <meta name="msapplication-TileImage" content="<?php echo base_url(); ?>public/img/favicon/mstile-144x144.png">
  <!-- For Windows Phone -->
        ...
        <ul id="slide-out" class="side-nav leftside-navigation">
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan"><i class="mdi-editor-insert-comment active"></i> Forms</a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="form-elements.html">Form Elements</a>
                                </li>
                                <li class="active"><a href="form-layouts.html">Form Layouts</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                ...
                <div class="row">
                  ...
                  <form class="col s12" method="post" action="<?php echo base_url()?>display_view/submit_grades/<?php echo $query['assignment_id']?>">
                    <div class="row">
                        ...
                        <div class="col s6">
                          <h4 class="header2"><?php echo $query['course_name']?></h4>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class=" col s6">
                          <label for="first_name"><b><font size="5">Submission time</font></b></label>
                        </div>
                        <div class="col s6">
                          <h4 class="header2"><?php echo $query['submiss_time']?></h4>
                        </div>
