...
<html class="st-layout ls-top-navbar-large ls-bottom-footer show-sidebar sidebar-l3" lang="en">
    <head>
        ...
        <title><?php echo "Add Question | ".$this->config->item('sitename');?></title>
        <!-- Vendor CSS BUNDLE
                                                ...
                                                <div class="col-lg-12">
                                                    <form method="post" action="<?php echo site_url('quiz/qbank/add_new');?>">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control selectpicker" style="width:50%"  name="qus_type" OnChange="get_ques_type(this.value)">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="question" row="5" class="summernote"></textarea>
                                                            
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Description (Optional)</label>
                                                            <textarea name="description" row="5" class="summernote"></textarea>
                                                            <p class="help-block">
                                                        ...
                                                        <div class="form-group">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td valign="top">
                                                                        <input class="form-control" name="option[]" type="text"> Ex: option1=Answer1
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td valign="top" style="height:30px;">2) &nbsp;&nbsp;</td>
                                                                    <td valign="top">
                                                                        <input class="form-control" name="option[]" type="text"> Ex: option2=Answer2
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td valign="top" style="height:30px;" >3) &nbsp;&nbsp;</td>
                                                                    <td valign="top">
                                                                        <input class="form-control" name="option[]" type="text"> Ex: option3=Answer3
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td valign="top" style="height:30px;">4)  &nbsp;&nbsp; </td>
                                                                    <td valign="top">
                                                                        <input  class="form-control" name="option[]" type="text"> Ex: option4=Answer4 <?php $op="5"; ?>
                                                                    </td>
                                                                </tr>
                                                                <?php
                                                                ...
                                                                ?>
                                                                <tr><td valign="top" style="height:30px;"><?php echo $op.")"; ?> &nbsp;&nbsp;</td><td valign="top"><input class="form-control" name="option[]" type="text">  </td></tr>
                                                                <?php
                                                                $op++;
                                                                }
                                                                }
