                                                        ...
                                                        <div class="form-group">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td valign="top">
                                                                        <textarea name="option[]" row="2" class="summernote"></textarea> 
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                ?>
                                                                <tr><td valign="top"><?php echo $op.")"; ?> &nbsp;&nbsp; <input id="CheckBox[]" type="checkbox"  name="CheckBox[]" value="<?php echo $op-1; ?>" /></td><td valign="top"><textarea name="option[]" row="2" class="summernote"></textarea>  </td></tr>
                                                                <?php
                                                                $op++;
                                                                }
                                                                }
