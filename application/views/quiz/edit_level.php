...
<html class="st-layout ls-top-navbar-large ls-bottom-footer show-sidebar sidebar-l3" lang="en">
    <head>
        ...
        <title><?php echo "Edit Level | ".$this->config->item('sitename');?></title>
        <!-- Vendor CSS BUNDLE
                ...
                <div class="st-content">
                    ...
                    <div class="st-content-inner padding-none">
                        <div class="container-fluid">
                            ...
                            ?>
                            <form method="post" action="<?php echo site_url('quiz/difficultlevel/update_level/'.$did);?>">
                                <a href="<?php echo site_url('quiz/difficultlevel');?>"   class="btn btn-danger">Back</a>
