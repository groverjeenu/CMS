...
<div class="searchbox" id="reportbox">
	...
	<form method="post" action="<?php echo site_url('quiz/result/get_report');?>">
...
<form method="post" action="<?php echo site_url('quiz/result');?>">
					...
					<table class="table table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td data-th="Action">
									<a href="<?php echo site_url('quiz/result/view/'.$row->rid.'/'.$row->quid);?>" class="btn btn-warning btn-xs">View</a>
									<?php
									if($this->ion_auth->in_group('faculty')){
									?>
									<a href="<?php echo site_url('quiz/result/remove_result/'.$row->rid);?>" class="btn btn-danger btn-xs">Remove</a>
									<?php
									}
									?>
								</td>
...
if($this->ion_auth->in_group('faculty')){
?>
<a href="<?php echo site_url('quiz/result/index/'.$back);?>"   class="btn btn-primary">Back</a>
&nbsp;&nbsp;
<?php
$next=$limit+($this->config->item('number_of_rows'));  ?>
<a href="<?php echo site_url('quiz/result/index/'.$next);?>"   class="btn btn-primary">Next</a>
<?php
}else{
?>
<a href="<?php echo site_url('quiz/result/user/'.$back);?>"   class="btn btn-primary">Back</a>
&nbsp;&nbsp;
<?php
$next=$limit+($this->config->item('number_of_rows'));  ?>
<a href="<?php echo site_url('quiz/result/user/'.$next);?>"  class="btn btn-primary">Next</a>
<?php
}
?>