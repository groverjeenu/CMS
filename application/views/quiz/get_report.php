...
?>
<tr>
<td><?php echo $row->rid;?></td><td><?php echo $row->username;?></td><td><?php echo $row->first_name;?> <?php echo $row->last_name;?></td><td><?php echo $row->email;?></td><td><?php echo $row->quiz_name;?></td><td><?php echo $row->score;?></td><td><?php echo substr($row->percentage , 0, 5 );?>%</td><td><?php if($row->q_result == "1"){  echo "Pass"; }else{ echo "Fail"; } ?> </td></tr>
<?php
}
}
?>
