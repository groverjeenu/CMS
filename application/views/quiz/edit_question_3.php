                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <form method="post" action="<?php echo site_url('quiz/qbank/edit_question/'.$result['0']['qid']).'/3';?>">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="question" class="summernote" row="5"><?php echo $result['0']['question'];?></textarea>
                                                            
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Description (Optional)</label>
                                                            <textarea name="description" class="summernote" row="5" ><?php echo $result['0']['description'];?></textarea>
                                                            <p class="help-block">
