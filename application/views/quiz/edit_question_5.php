                                ...
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <form method="post" action="<?php echo site_url('quiz/qbank/edit_question/'.$result['0']['qid'].'/5');?>">
                                                        ...
                                                        <div class="form-group">
                                                            <table>
                                                                ...
                                                                <input type="text" class="form-control" name="option[]" value="<?php echo $option_value['option_value'];?>">Ex: option<?php echo $okey+1; ?>=Answer<?php echo $okey+1; ?>  </td></tr>
                                                                <?php
                                                                }
                                                                $op=$okey+2;
                                                                ...
                                                                ?>
                                                                <tr><td valign="top"><?php echo $op.")"; ?> &nbsp;&nbsp; </td><td valign="top"><input type="text" class="form-control" name="option[]">Ex: option<?php echo $op; ?>=Answer<?php echo $op; ?> </td></tr>
                                                                <?php
                                                                $op++;
                                                                }
                                                                }
                                        ...
                                        <div class="panel-footer">
                                            <form method="post" class="form-inline" action="<?php echo site_url('quiz/qbank/edit_question/'.$result['0']['qid'].'/5');?>">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <input type="submit" value="Add"   class="form-control btn btn-primary col-sm-3" />
                                                </div>
                                            </form>
                                        </div>
                                    </div>
