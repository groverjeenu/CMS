          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="app-take-course.html">Take Course</a></li>
        ...
        <ul class="sidebar-menu sm-icons-right">
          ...
          <li class="hasSubmenu active open">
            ...
            <ul id="course-menu" class="in">
              ...
              <li class="active"><a href="app-take-course.html"><span>Take Course</span></a></li>
      ...
      <div class="split-vertical">
        ...
        <div class="sidebar-block">
          <div class="media margin-none">
            ...
            <div class="media-body">
              <h4 class="sidebar-heading media-heading">
                <a href="#sidebar-course-info" data-toggle="collapse">Github Webhooks</a>
              </h4>
            </div>
          </div>
          <div class="collapse" id="sidebar-course-info">
            ...
            <hr/>
            <a class="btn btn-white btn-sm paper-shadow relative" data-animated data-z="0.5" data-hover-z="1" href="app-student-course.html">Course details</a>
          </div>
        </div>
          ...
          <div class="split-vertical-cell">
            <div data-scrollable>
              ...
              <ul class="sidebar-menu sm-bordered sm-active-item-bg">
                <li class="active"><a href="app-take-course.html">Curriculum</a></li>
                <li><a href="app-course-forums.html">Course Forums</a></li>
                <li><a href="app-take-quiz.html">Take Quiz</a></li>
                <li><a href="app-quiz-results.html">Quiz Results</a></li>
              </ul>
                ...
                <div class="media v-middle">
                  <div class="media-left">
                    <a href="" class="media-object">
                      <img class="img-circle" src="images/people/50/guy-1.jpg" alt="people" />
                    </a>
                  </div>
                  <div class="media-body">
                    <h4 class="sidebar-heading media-heading"><a href="">John. S</a></h4>
