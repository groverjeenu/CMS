...
<head>
  ...
  <title>Incourse | Parent Login</title>
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
      <?php $attributes = array('class' => 'login-form');
            echo form_open('welcome/view_ward_grades',$attributes);
      ?>
      <!-- <form class="login-form" method = "post" action = "<?php echo base_url(); ?>auth/login"> -->
        <div class="row">
          <div class="input-field col s12 center">
            ...
            <p class="center login-form-text">Incourse View</p>
          </div>
        </div>
        <div class="row margin">
          <div class="input-field col s12">
            <i class="mdi-social-person-outline prefix"></i>
            <input id="identity" type="text" name = "ward_email" value = "<?php echo set_value('identity') ?>" >
            <label for="ward_email" class="center-align">Ward's Email</label>
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <input id="password" type="password" name = "passkey">
            <label for="password">Parental Passkey</label>
        ...
        <div class="row">
          <div class="input-field col s12">
            <button type="submit" class="btn waves-effect waves-light col s12">View Grades</button>
          </div>
        </div>
